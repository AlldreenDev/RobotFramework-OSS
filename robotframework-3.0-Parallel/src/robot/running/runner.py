...
from .context import unique_executioncontexts_obj_for_thread
...
class Runner(SuiteVisitor):
    ...
    @property
    def _context(self):
        return unique_executioncontexts_obj_for_thread().current
    ...
    def start_suite(self, suite):
        ...
        unique_executioncontexts_obj_for_thread().start_suite(result, ns, self._output,
